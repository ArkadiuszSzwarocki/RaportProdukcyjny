#!/usr/bin/env python
"""
Zmień podział palet na dokładne wartości:
- MILK BAND BIAŁE: 2×1000 + 1×60 kg
- MOM INSTANT: 11×1000 + 1×200 kg
- HOLENDER: 8×1000 + 1×420 kg
"""
...
# Specyfikacja nowych palet
palety_spec = {
    'MILK BAND BIAŁE': [1000, 1000, 60],
    'MOM INSTANT': [1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 200],
    'HOLENDER': [1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 420],
}

print(f'\n{"="*100}')
print(f'ZMIANA PODZIAŁU PALET ({today})')
print(f'{"="*100}\n')
...
print(f'\n{"="*100}')
print(f'✅ ZMIANA PALET ZAKOŃCZONA')
