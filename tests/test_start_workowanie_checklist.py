...
class TestStartWorkowanieChecklist:
    ...
    def test_start_agro_workowanie_accepts_operator_checklist(
        ...
        mock_cursor.fetchone.side_effect = [
            ("AGRO TEST", 1200, "Workowanie", date(2026, 5, 20), "AGRO", "zaplanowane", 0, 7, 3, "P001"),
            None,
        ]
    ...
    @patch("app.blueprints.routes_production_orders.get_table_name", return_value="plan_produkcji_agro")
    @patch("app.blueprints.routes_production_orders.get_db_connection")
    def test_start_agro_workowanie_bigbag_allows_missing_opakowanie_id(
        self,
        mock_get_db_connection,
        _mock_get_table_name,
        mock_audit_log,
        ...
        # Big Bag plan: typ_produkcji = "bigbag", opakowanie_id = None, etykieta_id = 5, nr_partii = "BB100"
        mock_cursor.fetchone.side_effect = [
            ("AGRO BIG BAG", 1200, "Workowanie", date(2026, 5, 20), "bigbag", "zaplanowane", 0, None, 5, "BB100"),
            None,
        ]
