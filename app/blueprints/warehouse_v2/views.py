...
def index():
    ...
    return render_template('warehouse_v2/dashboard.html', items=items, linia=linia, zakladki=magazyny_zakladki, aktywna_zakladka='all', stats=stats, printers=printers, fefo_pallets=fefo_pallets)
