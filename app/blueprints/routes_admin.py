...
from app.blueprints.routes_admin_backups import register_admin_backup_routes
from app.blueprints.routes_admin_bugs import register_admin_bug_routes
from app.blueprints.routes_admin_diagnostics import register_admin_diagnostics_routes
from app.blueprints.routes_admin_production import register_admin_production_routes
from app.blueprints.routes_admin_roles import register_admin_roles_routes
from app.blueprints.routes_admin_system import register_admin_system_routes
from app.blueprints.routes_admin_team import register_admin_team_routes
from app.blueprints.routes_admin_workowanie_times import register_admin_workowanie_times_routes
