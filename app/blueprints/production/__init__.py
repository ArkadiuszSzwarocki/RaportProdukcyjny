...
from .przestoje import register_production_przestoje_routes
...
register_production_przestoje_routes(production_bp, bezpieczny_powrot)

@production_bp.route('/api/zasyp_etapy_times', methods=['GET'])
@login_required
def get_zasyp_etapy_times():
    from app.blueprints.admin.zasyp_etapy_times import _load_times_config
    return jsonify(_load_times_config())
